  ...
  return (
    <div className="bg-black py-0">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-white">TV Show</h2>
              ...
              <div className="mt-4 block justify-between text-center">
                <div>
                  <h3 className="text-base text-white">
                    <a
                      href={`https://www.themoviedb.org/tv/${series.id}/videos?active_nav_item=Trailers`}
                    //   href={`https://youtu.be/${series.key}`}
                      target="_blank"
